    ...
    >
      <div className="flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg">
        <p className="text-2xl font-semibold m-auto">
          <span className="text-cyan-900">{state} </span>Login
        </p>
        ...
        <button
          className="bg-cyan-900 text-white w-full py-2 rounded-md text-base"
          type="submit"
        >
          Login
        </button>
        {state === "Admin" ? (
          <p>
            Teacher Login?{" "}
            <span
              className="text-cyan-900 underline cursor-pointer"
